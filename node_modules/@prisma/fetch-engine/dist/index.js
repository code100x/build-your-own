...
__export(dist_exports, {
  ...
  download: () => import_chunk_4BAMIYTJ.download,
  engineEnvVarMap: () => import_chunk_PXQVM7NP.engineEnvVarMap,
  getBinaryEnvVarPath: () => import_chunk_PXQVM7NP.getBinaryEnvVarPath,
  getBinaryName: () => import_chunk_4BAMIYTJ.getBinaryName,
  getCacheDir: () => import_chunk_5T2KHPZI.getCacheDir,
  getProxyAgent: () => import_chunk_KDPLGCY6.getProxyAgent,
  getVersion: () => import_chunk_4BAMIYTJ.getVersion,
  maybeCopyToTmp: () => import_chunk_4BAMIYTJ.maybeCopyToTmp,
  overwriteFile: () => import_chunk_5T2KHPZI.overwriteFile,
  plusX: () => import_chunk_4BAMIYTJ.plusX,
  vercelPkgPathRegex: () => import_chunk_4BAMIYTJ.vercelPkgPathRegex
});
module.exports = __toCommonJS(dist_exports);
var import_chunk_4BAMIYTJ = require("./chunk-4BAMIYTJ.js");
