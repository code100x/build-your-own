...
// ../../node_modules/.pnpm/@prisma+engines-version@5.19.0-31.5fe21811a6ba0b952a3bc71400666511fe3b902f/node_modules/@prisma/engines-version/package.json
var require_package = __commonJS({
  "../../node_modules/.pnpm/@prisma+engines-version@5.19.0-31.5fe21811a6ba0b952a3bc71400666511fe3b902f/node_modules/@prisma/engines-version/package.json"(exports2, module2) {
    module2.exports = {
...
// ../../node_modules/.pnpm/@prisma+engines-version@5.19.0-31.5fe21811a6ba0b952a3bc71400666511fe3b902f/node_modules/@prisma/engines-version/index.js
var require_engines_version = __commonJS({
  "../../node_modules/.pnpm/@prisma+engines-version@5.19.0-31.5fe21811a6ba0b952a3bc71400666511fe3b902f/node_modules/@prisma/engines-version/index.js"(exports2) {
    "use strict";
  ...
  "package.json"(exports2, module2) {
    module2.exports = {
      ...
      devDependencies: {
        ...
        "@prisma/query-engine-wasm": "5.19.0-31.5fe21811a6ba0b952a3bc71400666511fe3b902f",
...
function buildDbEnums(list) {
  ...
  for (const dbEntry of list) {
    file2.add(buildDbEnum(dbEntry));
  }
  return stringify(file2);
}
function buildDbEnum(dbEnum) {
  const type = unionType(dbEnum.values.map(stringLiteral));
  return moduleExport(typeDeclaration(dbEnum.name, type));
}
...
function buildIndexTs(queries, enums) {
  const file2 = file();
  if (!enums.isEmpty()) {
    file2.add(moduleExportFrom("./$DbEnums").asNamespace("$DbEnums"));
  }
...
function getMappingConfig(introspectionType, enums) {
  ...
  if (!config) {
    if (enums.hasEnum(introspectionType)) {
      const type = namedType(`$DbEnums.${introspectionType}`);
...
function buildTypedQueryTs({ query, runtimeBase, runtimeName, enums }) {
  ...
  if (queryUsesEnums(query, enums)) {
    file2.addImport(moduleImport("./$DbEnums").asNamespace("$DbEnums"));
  }
